...
import com.asiantech.intern20summer1.week11.activity.HomeActivityWeekEleven
...
class MainActivity : AppCompatActivity() {
    ...
    private fun handleButtonWeek11() {
        btnWeek11?.setOnClickListener {
            startActivity(Intent(this, HomeActivityWeekEleven::class.java))
        }
    }
}
