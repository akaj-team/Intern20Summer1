...
object SmoothSailing {
    ...
    fun main(args: Array<String>) {
        ...
        println("Ex 9: " + allLongestStrings(mutableListOf("aba", "aa", "ad", "vcd", "aba")))

        println("Ex 10: " + commonCharacterCount("aabcc", "adcaa"))

        println("Ex 11: " + isLucky(1395))

        println("Ex 12: " + sortByHeight(mutableListOf(-1, 150, 190, 170, -1, -1, 160, 180)))

        println("Ex 13: " + reverseInParentheses("foo(bar)baz(blim)"))
    }

    private fun allLongestStrings(inputArray: MutableList<String>): Array<String> {
        /**
    ...
    private fun charRemoveAt(str: String, charIndex: Int): String {
        /**
    ...
    private fun reverseInParentheses(a: String): String {
        /**
