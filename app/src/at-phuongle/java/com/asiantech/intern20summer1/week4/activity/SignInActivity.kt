...
import com.asiantech.intern20summer1.week4.fragment.LoginFragment
import com.asiantech.intern20summer1.week4.fragment.RegisterFragment
...
class SignInActivity : AppCompatActivity() {
    ...
    internal fun replaceRegisterFragment(isAddToBackTack: Boolean) {
        val beginTransaction = supportFragmentManager.beginTransaction()
        beginTransaction.replace(R.id.frameLayout, RegisterFragment.newInstance())
        if (isAddToBackTack) {
            beginTransaction.addToBackStack(RegisterFragment.newInstance().javaClass.simpleName)
        }
        beginTransaction.commit()
    }
